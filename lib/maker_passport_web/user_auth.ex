defmodule MakerPassportWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_maker_passport_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      MakerPassportWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule MakerPassportWeb.PageLive do
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{MakerPassportWeb.UserAuth, :ensure_authenticated}] do
